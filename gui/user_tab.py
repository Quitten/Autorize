...
class UserTab():
    ...
    def draw(self):
        ...
        self.addUserBtn.addActionListener(RemoveUserAction(self))
        buttonPanel.add(self.removeUserBtn)

        self.duplicateUserBtn = JButton("Duplicate User")
        self.duplicateUserBtn.addActionListerner(DuplicateUserAction(self))
    ...
    def add_user(self):
        ...
        headerLabel.setFont(Font("Tahoma", Font.BOLD, 16))
